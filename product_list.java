...
public class product_list extends AppCompatActivity implements RecyclerviewAdapter.Onitemlistener{
    ...
    public RecyclerviewAdapter createadapter(ArrayList<String> list){
        return new RecyclerviewAdapter(list, this);

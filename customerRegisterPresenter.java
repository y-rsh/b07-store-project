...
public class customerRegisterPresenter implements RegisterContract.Presenter {
    private RegisterContract.Model model;
    private RegisterContract.View view;

    public customerRegisterPresenter(RegisterContract.Model model, RegisterContract.View view){
        this.model = model;
        this.view = view;
    }

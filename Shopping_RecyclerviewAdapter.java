...
public class Shopping_RecyclerviewAdapter extends RecyclerView.Adapter<Shopping_RecyclerviewAdapter.MainViewHolder>{

    private final ArrayList<String> itemData;
    private final Onitemlistener mOnitemlistener;

    public Shopping_RecyclerviewAdapter(ArrayList<String> itemData, Onitemlistener onitemlistener) {
